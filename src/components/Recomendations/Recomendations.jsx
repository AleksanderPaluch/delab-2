          ...
          <ul className={css.list}>
            ...
            <li className={css.item}>
              <p>
                ...
                Pamiętaj, że możesz być zobowiązany/a do zaraportowania takiego
                użycia.
            ...
            <li className={css.item}>
              <p>
                ...
                być odpowiednio cytowane. Uważaj na problem “nieintencjonalnego
                plagiatu”. →{" "}
          ...
          <ul className={css.list}>
            ...
            <li className={css.item}>
              <p>
                ...
                uwzględnij je w sylabusie. Jeśli sam/a używasz generatywnej AI w
                nauczaniu, poinformuj o tym swoich studentów. →{" "}
                <a href="https://docs.google.com/document/d/1AT2ocGuGsHhxnWGehLP9QVdYcwX0Fuuvkv6p-7MM0oE/edit#bookmark=id.r23rp2jnxfsg">
                  więcej
                </a>
              </p>
          ...
          <ul className={css.list}>
            ...
            <li className={css.item}>
              <p>
                ...
                korzystania z narzędzi generatywnej AI w ramach kursu, postępuj
                zgodnie z{" "}
