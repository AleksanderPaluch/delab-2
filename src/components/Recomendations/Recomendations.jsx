      ...
      <div className={css.recomendBox}>
        ...
        <ul className={css.list}>
          <li className={css.item}>
            ...
            sztucznej inteligencji w procesie kształcenia, które zostały zawarte
            w{" "}
            <a
          ...
          <li className={css.item}>
            <p>
              Nie wprowadzaj żadnych danych poufnych a także danych osobowych
              (np. imię, nazwisko, numer indeksu, telefonu, pesel itp.) do
              narzędzi generatywnej AI. Pamiętaj, że dane i treści wytwarzane
              przez osoby studiujące (np. prace zaliczeniowe, egzaminy), jak i
              pracujące na UW (np. prezentacje z wykładów, artykuły czy
              materiały do nauki) objęte są ochroną. →{" "}
          ...
          <li className={css.item}>
            <p>
              ...
              generatywnej AI w swojej dziedzinie. Zapoznaj się z przykładowym
              użyciem narzędzi genAI w →{" "}
          ...
          <li className={css.item}>
            <p>
              Śledź i zapisuj swoje sposoby korzystania z narzędzi generatywnej
              AI podczas studiowania i pracy na Uniwersytecie. Pamiętaj, że
              możesz być zobowiązany/a do zaraportowania takiego użycia.
        ...
        <ul className={css.list}>
          ...
          <li className={css.item}>
            <p>
              ...
              podają błędną ocenę. Nie opieraj swojej oceny wyłącznie na
              wynikach przez nie wygenerowanych. →{" "}
        ...
        <ul className={css.list}>
          ...
          <li className={css.item}>
            <p>
              Jeżeli prowadzący/a nie podaje informacji o sposobach korzystania
              z narzędzi generatywnej AI w ramach kursu, postępuj zgodnie z{" "}
