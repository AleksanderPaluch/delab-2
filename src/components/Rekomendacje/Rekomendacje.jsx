    ...
    <div className={css.recomendBox}>
      ...
      <ul className={css.list}>
        <li className={css.item}>
          ...
          sztucznej inteligencji w procesie kształcenia, które zostały zawarte w{" "}
          <a
        ...
        <li className={css.item} >
          <p>
            Nie wprowadzaj żadnych danych poufnych a także danych osobowych (np.
            imię, nazwisko, numer indeksu, telefonu, pesel itp.) do narzędzi
            generatywnej AI. Pamiętaj, że dane i treści wytwarzane przez osoby
            studiujące (np. prace zaliczeniowe, egzaminy), jak i pracujące na UW
            (np. prezentacje z wykładów, artykuły czy materiały do nauki) objęte
            są ochroną. →{" "}
        ...
        <li className={css.item}>
          <p>
            ...
            wprowadzone oraz wygenerowane treści mogą zostać udostępnione dalej.
             <a href="">więcej</a>
          </p>
        </li>
        <li className={css.item}>
          <p>
            ...
            związanymi z narzędziami generatywnej AI i ustosunkowanie się – w
            oparciu o dostępne materiały i argumenty – do tych wyzwań. →{" "}
            <a href="">więcej</a>
          </p>
        </li>
        <li className={css.item}>
          <p>
            ...
            AI w swojej dziedzinie. Zapoznaj się z przykładowym użyciem narzędzi
            genAI w →{" "}
        ...
        <li className={css.item}>
          <p>
            Śledź i zapisuj swoje sposoby korzystania z narzędzi generatywnej AI
            podczas studiowania i pracy na Uniwersytecie. Pamiętaj, że możesz
            być zobowiązany/a do zaraportowania takiego użycia.
        ...
        <li className={css.item}>
          <p>
            ...
            generatywnej AI. Pamiętaj, że jesteś w pełni odpowiedzialny/a za
            treści, które promujesz i publikujesz. →{" "}
        ...
        <li className={css.item}>
          <p>
            Pamiętaj, że treści wygenerowane przez generatywną AI powinny być
            odpowiednio cytowane. Uważaj na problem “nieintencjonalnego
            plagiatu”. →{" "}
        ...
        <li className={css.item}>
          <p>
            ...
            kompetencji. Zapoznaj się z materiałami przygotowanymi przez DELab
            UW i INNE OŚRODKI??? →{" "}
        ...
        <li className={css.item}>
          <p>
            ...
            rozwija, a przedstawione rekomendacje dotyczą jej możliwości na
            dzień XXXXX. Rekomendacje mogą ulec zmianie, zarówno w związku z
            regulacjami prawnymi, jak i rozszerzającymi się możliwościami
            technologii.
          </p>
        </li>
      </ul>
      ...
      <ul className={css.list}>
        <li className={css.item}>
          <p>
            Przemyśl i przeformułuj swoje kursy tak, aby uwzględniały zmiany
            zachodzące w związku z możliwościami generatywnej AI. →{" "}
        ...
        <li className={css.item}>
          <p>
            Na początku każdego kursu jasno określ swoje oczekiwania dotyczące
            korzystania z generatywnej AI przez studentów/ki i uwzględnij je w
            sylabusie. Jeśli sam/a używasz generatywnej AI w nauczaniu,
            poinformuj o tym swoich studentów. →{" "}
            <a href="https://docs.google.com/document/d/1AT2ocGuGsHhxnWGehLP9QVdYcwX0Fuuvkv6p-7MM0oE/edit#bookmark=id.r23rp2jnxfsg">
              więcej
            </a>
          </p>
        ...
        <li className={css.item}>
          <p>
            Zwróć uwagę na dostępność narzędzi generatywnej AI. Płatne wersje
            zazwyczaj generują “lepsze” treści, jednak nie każdy student może
            mieć do nich dostęp. Niektóre narzędzia generatywnej AI posiadają
            także ograniczenia wiekowe. →{" "}
            <a href="https://docs.google.com/document/d/1AT2ocGuGsHhxnWGehLP9QVdYcwX0Fuuvkv6p-7MM0oE/edit#bookmark=id.r23rp2jnxfsg">
              więcej
            </a>
          </p>
        ...
        <li className={css.item}>
          <p>
            Pamiętaj, że rozwiązania wykrywające użycie generatywnej AI często
            podają błędną ocenę. Nie opieraj swojej oceny wyłącznie na wynikach
      ...
      <ul className={css.list}>
        <li className={css.item}>
          <p>
            Zapoznaj się z zasadami korzystania generatywnej AI w ramach różnych
            etapów kursu: na zajęciach, podczas wykonywania prac domowych,
            zaliczeniowych i egzaminu. W przypadku jakichkolwiek niepewności –
            dopytaj osoby prowadzącej zajęcia. →{" "}
            <a href="https://docs.google.com/document/d/1AT2ocGuGsHhxnWGehLP9QVdYcwX0Fuuvkv6p-7MM0oE/edit#bookmark=id.9e1k5yz7z9kz">
              więcej
            </a>
          </p>
        ...
        <li className={css.item}>
          <p>
            Jeżeli prowadzący/a nie podaje informacji o sposobach korzystania z
            narzędzi generatywnej AI w ramach kursu, postępuj zgodnie z{" "}
        ...
        <li className={css.item}>
          <p>
            Pamiętaj, aby rozwijać swoje kompetencje związane z narzędziami
            generatywnej AI, ponieważ mogą być kluczowe na rynku pracy. →{" "}
            <a href="https://docs.google.com/document/d/1AT2ocGuGsHhxnWGehLP9QVdYcwX0Fuuvkv6p-7MM0oE/edit#bookmark=id.lgsm2y6ly6qc">
              więcej
            </a>
          </p>
