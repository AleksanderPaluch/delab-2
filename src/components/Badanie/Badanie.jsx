    ...
    <section className={css.section}>
      <div className={css.box}>
        ...
        <p className={css.item}>
          ...
          zrozumienie, jak osoby związane z UW postrzegają potencjał i wyzwania
          generatywnej AI oraz jak ją wykorzystują w pracy i nauce. Przez cztery
          miesiące zebrano niemal 2000 odpowiedzi, z czego w raporcie
          analizowane są wyniki od 1778 studentów, doktorantów i pracowników
          naukowo-dydaktycznych. Wyniki przedstawiono w formie pytań z ankiety,
